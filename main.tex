...
\begin{frame}{Research Theme}
    ...
    \begin{columns}[T,onlytextwidth]
        ...
        \uncover<4->{%
            \vspace{0.1em}
            \centering
            {\color{themecolor}\large$\downarrow$}\\[0.15em]
            \small\textbf{Efficient, surgical model editing}\par
        }
        ...
        \uncover<4->{%
            ...
            \centering
            {\color{themecolor}\large$\downarrow$}\\[0.15em]
            \small\textbf{Data attribution}\\
            \small\textbf{Dataset selection}\\
            \small\textbf{Machine unlearning}\par
        }
    \end{columns}
\end{frame}
